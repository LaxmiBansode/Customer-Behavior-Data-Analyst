...
• Excel for initial data familiarization and structure validation
• Python for data cleaning, transformation, feature engineering, and EDA
• MySQL for storing structured data and performing business-focused queries
...
• How customers can be segmented based on purchasing behavior
• Differences between subscribed and non-subscribed customers
• The role of discounts in influencing purchase value
...
• Clear identification of high-value and loyal customer segments
• Deeper understanding of key drivers impacting revenue and retention
• Actionable insights to support marketing and customer engagement strategies
...
• Strong business problem understanding
• Structured and scalable data analysis
• Insight-driven decision-making
• Clear communication through visuals and presentations
